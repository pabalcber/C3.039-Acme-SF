...
public interface ManagerDashboardRepository extends AbstractRepository {
	...
	@Query("select avg(p.cost.amount) from Project p where p.cost.currency = :currency and p.manager.id = :managerId")
	...
	@Query("select stddev(p.cost.amount) from Project p where p.cost.currency = :currency and p.manager.id = :managerId")
	...
	@Query("select min(p.cost.amount) from Project p where p.cost.currency = :currency and p.manager.id = :managerId")
	...
	@Query("select max(p.cost.amount) from Project p where p.cost.currency = :currency and p.manager.id = :managerId")
